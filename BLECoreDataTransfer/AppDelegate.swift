...
//        application.registerUserNotificationSettings(<#T##notificationSettings: UIUserNotificationSettings##UIUserNotificationSettings#>)
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        CentralViewController.isRunningBackground = true
    }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        CentralViewController.isRunningBackground = false
    }
...
//    lazy var managedObjectModel
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "BLECoreDataTransfer")
